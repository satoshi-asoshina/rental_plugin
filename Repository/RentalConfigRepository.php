...
class RentalConfigRepository extends AbstractRepository
{
    ...
    {
        return $this->getBoolean(RentalConfig::AUTO_APPROVAL, false);
    }
    ...
    {
        return $this->getInt(RentalConfig::MAX_RENTAL_DAYS, 30);
    }
    ...
    {
        return $this->getInt(RentalConfig::MIN_RENTAL_DAYS, 1);
    }
    ...
    {
        return $this->getInt(RentalConfig::REMINDER_DAYS, 3);
    }
    ...
    {
        return $this->getFloat(RentalConfig::OVERDUE_FEE_RATE, 0.1);
    }
    ...
    {
        return $this->getBoolean(RentalConfig::DEPOSIT_REQUIRED, false);
    }
    ...
    {
        $businessDays = $this->get(RentalConfig::BUSINESS_DAYS, '1,2,3,4,5');
    ...
    {
        return $this->getBoolean(RentalConfig::HOLIDAY_RENTAL, true);
    }
    ...
    {
        return $this->get(RentalConfig::NOTIFICATION_EMAIL, '');
    }
    ...
    {
        return $this->get(RentalConfig::TERMS_OF_SERVICE, '');
    }
